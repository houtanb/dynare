function [endogenousvariables, info] = ...
    solve_stacked_linear_problem(endogenousvariables, exogenousvariables, steadystate_y, steadystate_x, M, options, oo)
...
[d1,jacobian] = dynamicmodel(steadystate_y([ip; ic; in]), transpose(steadystate_x), ...
                             M.params, steadystate_y, oo.exo_steady_state, 1);
