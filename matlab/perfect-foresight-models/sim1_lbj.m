function [endogenousvariables, info] = sim1_lbj(endogenousvariables, ...
...
for iter = 1:options.simul.maxit
    ...
    [d1, jacobian] = feval(dynamicmodel, z, exogenousvariables, M.params, ...
                           steadystate, oo.exo_steady_state, it_);
