    ...
    if options_.bytecode
        ...
        if M_.maximum_endo_lead == 0 % Purely backward model
            [oo_.endo_simul, oo_.deterministic_simulation] = ...
                sim1_purely_backward(oo_.endo_simul, oo_.exo_simul, ...
                                     oo_.steady_state, M_, options_, oo_);
        elseif M_.maximum_endo_lag == 0 % Purely forward model
        [oo_.endo_simul, oo_.deterministic_simulation] = ...
            sim1_purely_forward(oo_.endo_simul, oo_.exo_simul, oo_.steady_state, ...
                                M_, options_, oo_);
        else % General case
            switch options_.stack_solve_algo
              case 0
                if options_.linear_approximation
                    [oo_.endo_simul, oo_.deterministic_simulation] = ...
                        sim1_linear(oo_.endo_simul, oo_.exo_simul, oo_.steady_state, ...
                                    oo_.exo_steady_state, M_, options_, oo_);
                else
                    [oo_.endo_simul, oo_.deterministic_simulation] = ...
                        sim1(oo_.endo_simul, oo_.exo_simul, oo_.steady_state, ...
                             M_, options_, oo_);
                end
              case 6
                if options_.linear_approximation
                ...
                [oo_.endo_simul, oo_.deterministic_simulation] = ...
                    sim1_lbj(oo_.endo_simul, oo_.exo_simul, oo_.steady_state, ...
                             M_, options_, oo_);
              case 7
                if options_.linear_approximation
                    ...
                    [oo_.endo_simul, oo_.deterministic_simulation] = ...
                        solve_stacked_linear_problem(oo_.endo_simul, oo_.exo_simul, ...
                                                     oo_.steady_state, oo_.exo_steady_state, M_, options_, oo_);
                else
                    [oo_.endo_simul, oo_.deterministic_simulation] = ...
